export const data1 = [
{
  ...
  "course": {
    ...
    "about": {
      "html_content": "Lorem ipsum text about managing relationships, communication, time management, and forgiveness."
    },
    "what_to_expect": {
      "html_content": "<li>Learn to mange your relationships</li><li>Better communication</li><li>Time management</li><li>Forgiveness</li></ul>"
    },
    "key_topics": {
